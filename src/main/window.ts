...
export function createWindow(): BrowserWindow {
  const window = new BrowserWindow({
    ...
    height: 660,
    minWidth: 360,
    // С запасом на самое высокое обычное состояние главного экрана (ошибка + три
    // результата проверки), чтобы полоса прокрутки в карточке не появлялась на ровном месте.
    minHeight: 560,
    show: false,
